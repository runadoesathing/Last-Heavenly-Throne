...
mov r1, #0x5A
ldrh r0, [ r4, r1 ]
add r0, #0x03 @ Add 3 attack.
strh r0, [ r4, r1 ]
mov r1, #0x5E
ldrh r0, [ r4, r1 ]
add r0, #0x03 @ Add 3 attack speed.
strh r0, [ r4, r1 ]
mov r1, #0x62
ldrh r0, [ r4, r1 ]
add r0, #0x06 @ Add 6 avoid.
strh r0, [ r4, r1 ]
...
@Bracing Stance- +3 res/def
@Darting Stance- +4 Speed 
@Fierce Stance - +4 Attack 
@Kestrel Stance- +3 atk/spd
@Mirror Stance- +3 atk/res
@Steady Stance- +4 def
@Sturdy Stance- +3 atk/def
@Ready Stance - +3 spd/def
@Swift Stance- +3 spd/res
@Warding Stance- +4 res
