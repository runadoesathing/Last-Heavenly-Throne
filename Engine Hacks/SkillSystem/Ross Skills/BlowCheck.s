...
add     r3,#0xF    @Add 15 to the attacker's avoid.
...
add     r3,#0xA    @Add 10 to the attacker's crit.
...
@ sub     r3,#0x6    @Subtract 6 from the defender's avoid.
...
@ add     r0,#0x5A    @Move to the defender's damage.
@ ldrh    r3,[r0]     @Load the defender's damage into r3.
@ sub     r3,#6    @Subtract 6 from the defender's avoid.
@ strh    r3,[r0]     @Store defender avoid.
...
add     r3,#4    @Add 3 to the attacker's dmg.
