...
mov r1, #0x5E
ldrh r0, [ r4, r1 ]
add r0, #0x04 @ Add 6 attack speed.
strh r0, [ r4, r1 ]
mov r1, #0x62
ldrh r0, [ r4, r1 ]
add r0, #0x08 @ Add 12 avoid.
strh r0, [ r4, r1 ]
...
mov r1, #0x5A
ldrh r0, [ r4, r1 ]
add r0, #0x03 @ Add 4 attack.
strh r0, [ r4, r1 ]
mov r1, #0x5E
ldrh r0, [ r4, r1 ]
add r0, #0x03 @ Add 4 attack speed.
strh r0, [ r4, r1 ]
mov r1, #0x62
ldrh r0, [ r4, r1 ]
add r0, #0x06 @ Add 8 avoid.
strh r0, [ r4, r1 ]
